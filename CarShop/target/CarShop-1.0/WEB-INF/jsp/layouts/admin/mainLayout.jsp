...
<body class="app">
											...
											<div
												...
												<div class="col-auto">
													<img class="profile-image"
														src="<c:url value="/resources/admin/images/profiles/profile-1.png"/>"
														alt="">
												</div>
												<!--//col-->
												<div class="col">
  ...
  <path fill-rule="evenodd"
										...
										<div class="item p-3">
											<div
												...
												<div class="col-auto">
													<img class="profile-image"
														src="<c:url value="/resources/images/profiles/profile-2.png"/>"
														alt="">
												</div>
												<!--//col-->
												<div class="col">
  ...
  <path fill-rule="evenodd"
							...
							<div class="app-utility-item app-user-dropdown dropdown">
								<a class="dropdown-toggle" id="user-dropdown-toggle"
									...
									src="<c:url value="/resources/admin/images/user.png"/>"
									alt="user profile"></a>
  ...
  <path fill-rule="evenodd"
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link"
							href="${pageContext.request.contextPath }/admin/home-bookingservice">
  ...
  <circle cx="3.5" cy="10.5" r=".5" />
	  ...
	  <path
							...
							</span> <span class="nav-link-text">Management</span> <span
	  ...
	  <path fill-rule="evenodd"
							...
							<div id="submenu-1" class="collapse submenu submenu-1"
								...
								<ul class="submenu-list list-unstyled">
									...
									<li class="submenu-item"><a class="submenu-link"
										href="${pageContext.request.contextPath }/admin/home-servicecar">Service
											Car</a></li>
								</ul>
							</div>
						</li>
	  ...
	  <path
							...
							</span> <span class="nav-link-text">POST</span> <span
								class="submenu-arrow"> <svg width="1em" height="1em"
										viewBox="0 0 16 16" class="bi bi-chevron-down"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	  <path fill-rule="evenodd"
							...
							<div id="submenu-3" class="collapse submenu submenu-1"
								data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
