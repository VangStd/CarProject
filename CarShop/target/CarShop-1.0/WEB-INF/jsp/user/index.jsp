	...
	<div id="header-carousel" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="w-100"
					src="<c:url value="/resources/img/carousel-bg-1.jpg"/>" alt="Image">
					...
					<div class="container">
						<div
							...
							<div class="col-lg-5 d-none d-lg-flex animated zoomIn">
								<img class="img-fluid"
									src="<c:url value="/resources/img/carousel-1.png"/>" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="carousel-item">
				<img class="w-100"
					src="<c:url value="/resources/img/carousel-bg-2.jpg"/>" alt="Image">
				<div class="carousel-caption d-flex align-items-center">
					<div class="container">
						<div
							class="row align-items-center justify-content-center justify-content-lg-start">
							...
							<div class="col-lg-5 d-none d-lg-flex animated zoomIn">
								<img class="img-fluid"
									src="<c:url value="/resources/img/carousel-2.png"/>" alt="">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row g-4">
			...
			<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
				<div class="team-item">
					<div class="position-relative overflow-hidden">
						<img class="img-fluid"
							src="<c:url value="/resources/img/team-4.jpg"/>" alt="">
						<div
							class="team-overlay position-absolute start-0 top-0 w-100 h-100">
							<a class="btn btn-square mx-1" href=""><i
								class="fab fa-facebook-f"></i></a> <a class="btn btn-square mx-1"
...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
	<div class="container">
		...
		<div class="owl-carousel testimonial-carousel position-relative">
			...
			<div class="testimonial-item text-center">
				<img class="bg-light rounded-circle p-2 mx-auto mb-3"
					src="<c:url value="/resources/img/testimonial-2.jpg"/>"
					style="width: 80px; height: 80px;">
				<h5 class="mb-0">Client Name</h5>
				<p>Profession</p>
				<div class="testimonial-text bg-light text-center p-4">
