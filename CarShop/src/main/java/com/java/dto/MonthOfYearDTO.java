...
public class MonthOfYearDTO {
	...
	public MonthOfYearDTO(String month1, String month2, String month3, String month4, String month5, String month6,
	...
	public String toString() {
		return "month1=" + month1 + ", month2=" + month2 + ", month3=" + month3 + ", month4=" + month4 + ", month5="
				+ month5 + ", month6=" + month6 + ", month7=" + month7 + ", month8=" + month8 + ", month9=" + month9
