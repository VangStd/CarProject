			...
			<div class="col-lg-12">
				<form:form action="" method="post" modelAttribute="brandcar">
					...
					<div class="mb-3 mt-3">
						...
						<input type="hidden" value="${brandcar.companyName }"
							name="companyname_temp">
					...
					<div class="mb-3">
						...
						<input type="hidden" value="${brandcar.brandName }"
							name="brandname_temp">
					...
					<div class="mb-3">
						...
						<input type="hidden" value="${brandcar.phone }" name="phone_temp">
